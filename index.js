...
(async () => {
    ...
    console.log(`- suprekiauta suma: ${profit(goodsInfo)} ${currency(goodsInfo)}`)
    console.log(`- galimu pardavimu: ${futureProfit(goodsInfo)} ${currency(goodsInfo)}`)
    console.log(`- maksimali galima parduotuves apyvarta: ${(profit(goodsInfo) + futureProfit(goodsInfo)).toFixed(2)} ${currency(goodsInfo)}`)
